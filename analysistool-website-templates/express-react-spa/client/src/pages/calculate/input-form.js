...
export function InputForm({ className = "", params, onSubmit = (_) => {}, onReset = (_) => {} }) {
  ...
  function handleSubmit(e) {
    ...
    e.stopPropagation();
    setValidated(true);
    if (e.target.checkValidity()) onSubmit(formValue);
  }
      ...
      <Card className={className}>
        ...
        <Card.Body>
          <div className="form-group">
            <label htmlFor="a" className="font-weight-bold">
              Parameter A
            </label>
            <input
              id="a"
          ...
          <div className="form-group">
            <label htmlFor="b" className="font-weight-bold">
              Parameter B
            </label>
            <input
              id="b"
        ...
        <Card.Footer className="text-right bg-white">
          <Button variant="danger-outline" type="reset" className="mr-2">
            Clear
          </Button>
